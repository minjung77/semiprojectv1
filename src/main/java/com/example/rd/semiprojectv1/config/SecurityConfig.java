...
import com.example.rd.semiprojectv1.jwt.JwtAuthenticationFilter;
...
//                    .userDetailsService(userDetailService)
                    ...
                    .antMatchers("/member/logout", "member/myinfo", "/board/write", "/gallery/write", "board/reply").authenticated()// 인증 받은 사용자감 접근 가능
